...
// Uses globals: api, state, router, showToast, API_ROUTES, CLIENT_ROUTES, TOAST_TYPES, TASK_STATUS, formatDate, formatRelativeDate, getDaysUntilDue
...
(function () {
  ...
  function updateDonutChart(stats) {
    ...
    if (doneSegment) {
      ...
      const prevOffset =
        ((todoPercent + progressPercent) / 100) * circumference;
  ...
  // Expose dashboard page functions globally
