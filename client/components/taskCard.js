...
// Uses globals: TASK_STATUS, TASK_PRIORITY, STATUS_ORDER, formatDate, getDaysUntilDue
...
(function () {
      ...
      cardElement.innerHTML = `
            <div class="task-card-header">
                ...
                <div class="task-card-actions">
                    <button class="task-action-btn edit-btn" title="Edit" aria-label="Edit task">âœï¸</button>
                    <button class="task-action-btn delete-btn delete" title="Delete" aria-label="Delete task">ðŸ—‘ï¸</button>
                </div>
            </div>
            ...
            <div class="task-card-footer">
                ...
                <div class="task-navigation">
                    <button class="nav-btn prev" title="Move to previous status" aria-label="Move to previous status">â†</button>
                    <button class="nav-btn next" title="Move to next status" aria-label="Move to next status">â†’</button>
                </div>
            </div>
        `;
    }
  ...
  function createTaskRow(task, handlers = {}) {
    ...
    const statusIndicators = {
      [TASK_STATUS.TODO]: "âšª",
      [TASK_STATUS.IN_PROGRESS]: "ðŸ”µ",
      [TASK_STATUS.DONE]: "âœ…",
    };

    row.innerHTML = `
        <td class="status-cell">
            <span class="status-indicator">${statusIndicators[task.status] || "âšª"}</span>
        </td>
        <td class="title-cell">
        ...
        <td class="actions-cell">
            <button class="task-action-btn edit-btn" title="Edit">âœï¸</button>
            <button class="task-action-btn delete-btn" title="Delete">ðŸ—‘ï¸</button>
        </td>
    `;
